...
public class MainActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //getting surface view from xml file and text view
        surfaceView = findViewById(R.id.surfaceView);
        scoreTv = findViewById(R.id.ScoreTv);

        // getting image buttons from xml file
        final AppCompatImageButton topbtn = findViewById(R.id.topArrow);
        final AppCompatImageButton leftbtn = findViewById(R.id.leftArrow);
        final AppCompatImageButton rightbtn = findViewById(R.id.rightArrow);
        final AppCompatImageButton botmbtn = findViewById(R.id.bottomArrow);

        //adds call back to surface view
        ...
        botmbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view){
    ...
    private void init(){
        ...
        //moves snake to default starting postion
        int startPositionX = (pointSize)*defaultTalePoint;

        //makes snake default length
        for(int i =0; i<defaultTalePoint;i++){

            //adding points to snake score tale
